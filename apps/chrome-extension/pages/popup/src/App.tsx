...
// // tableData 변경 시 pinnedMarkets 기반으로 rowPinning 업데이트
// useEffect(() => {
//   const pinnedRowIds = tableData
//     .map((ticker, index) => (pinnedMarkets.includes(ticker.market!) ? `${index}` : null))
//     .filter(id => id !== null) as string[];
//   setRowPinning({ top: pinnedRowIds, bottom: [] });
// }, [tableData, pinnedMarkets]);

// // pinnedMarkets 변경 시 로컬 스토리지에 저장
