...
//   });
//   const [favoriteFunc, setFavoriteFunc] = useState(true);
//   const [favoriteCoinsLoaded, setFavoriteCoinsLoaded] = useState(false);
...
//       setFavoriteCoins(storageFavoriteCoins);
//       setFavoriteCoinsLoaded(true); // 로드 완료 시점 표시
//     });
//   }, []);
...
//     if (!favoriteCoinsLoaded) return 0; // 로드 전에는 0 반환
//     return favoriteCoins[exchangePlatform].filter(market => rawTableData.some(ticker => ticker.market === market))
//       .length;
//   }, [favoriteCoins, exchangePlatform, rawTableData, favoriteCoinsLoaded]);
...
//                     }`}
//                     style={{
//                       top: index < pinnedRowCount ? `${Math.round(index * 17) + 48}px` : undefined,
//                     }}>
//                     {row
//                       .getVisibleCells()
//                       .map(cell =>
