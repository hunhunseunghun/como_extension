...
const Table = React.forwardRef(({ className, ...props }, ref) => (_jsx("div", { className: "relative w-full ", children: _jsx("table", { ref: ref, className: cn('w-full caption-bottom text-sm border-spacing-y-1', className), ...props }) })));
Table.displayName = 'Table';
const TableHeader = React.forwardRef(({ className, ...props }, ref) => _jsx("thead", { ref: ref, className: cn('[&_tr]:border-0 ', className), ...props }));
...
const TableRow = React.forwardRef(({ className, ...props }, ref) => (_jsx("tr", { ref: ref, className: cn('transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted ', className), ...props })));
