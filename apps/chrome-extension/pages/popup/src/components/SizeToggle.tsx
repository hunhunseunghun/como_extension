...
export function SizeToggle({
  ...
  return (
    <Toggle
      ...
      <span className="absolute left-1/3 -translate-x-[80%] top-full mt-2 hidden w-max px-2 py-1 text-xs text-white bg-black # rounded-md opacity-0 group-hover:block group-hover:opacity-90 transition-opacity z-49">
